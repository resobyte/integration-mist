                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end space-x-3">
                        ...
                        <button
                          ...
                          className="text-success hover:text-success-dark text-sm font-medium disabled:opacity-50 flex items-center group"
                        >
                          {isApproving === claim.id ? (
                            <div className="h-4 w-4 border-2 border-success border-t-transparent rounded-full animate-spin mr-1.5" />
                          ) : (
                            <svg className="w-4 h-4 mr-1.5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
